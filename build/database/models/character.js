...
let Character = (() => {
    ...
    var Character = _classThis = class extends _classSuper {
        constructor() {
            ...
            this.species = (__runInitializers(this, _status_extraInitializers), __runInitializers(this, _species_initializers, void 0));
            this.location = (__runInitializers(this, _species_extraInitializers), __runInitializers(this, _location_initializers, void 0));
    ...
    (() => {
        ...
        _species_decorators = [Column({
                type: DataType.STRING,
            })];
        _location_decorators = [HasOne(() => Location)];
